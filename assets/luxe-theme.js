...
h+='<form action="/cart" method="post" novalidate class="cart-drawer__checkout-form"><button type="submit" id="checkout2" name="checkout" class="btn btn--primary btn--full">Checkout</button></form>';
